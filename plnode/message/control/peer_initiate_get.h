...
public:
	...
	PeerInitiateGET(string source_host, int source_port, string dest_host, int dest_port
	            ,OverlayID src_oid, OverlayID dst_id, string device_name) : ABSMessage(MSG_PEER_INITIATE_GET, source_host, source_port, dest_host,
