...
class Peer {
        ...
        bool init_rcvd, start_gen_name_rcvd, start_lookup__name_rcvd;
        int dyn_status;
...
<<<<<<< HEAD
        void INIT() {
                ...
                init_rcvd = false;
                start_gen_name_rcvd = start_lookup__name_rcvd = false;
...
>>>>>>> 5ddea6ecac3c0c4e5e021235e32f32df0b19ab5a
        ...
        void SetStart_lookup__name_rcvd(bool start_lookup__name_rcvd) {
                this->start_lookup__name_rcvd = start_lookup__name_rcvd;
        }

        bool IsStart_lookup__name_rcvd() const {
                return start_lookup__name_rcvd;
        }
