...
int main()
{
	...
	//create table device	
	db->query("CREATE TABLE IF NOT EXISTS device (username VARCHAR(100), devicename VARCHAR(100), type VARCHAR(100), ip VARCHAR(100), port VARCHAR(100), dir_ip VARCHAR(100), dir_port VARCHAR(100), public_folder VARCHAR(100), private_folder VARCHAR(100), last_seen INTEGER, os VARCHAR(100), description VARCHAR(500), content_meta varchar(1500), searchable INTEGER, content_timestamp INTEGER);");
